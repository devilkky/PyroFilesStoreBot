    ...
    try:
        ...
        if user.status == "kicked":
            await bot.send_message(
                ...
                text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/theimdbshow_supportgroup).",
                parse_mode="markdown",
        ...
        await bot.send_message(
            chat_id=cmd.from_user.id,
            text="Something went Wrong. Contact my [Support Group](https://t.me/theimdbshow_supportgroup).",
            parse_mode="markdown",
            disable_web_page_preview=True
        )
        return 200
